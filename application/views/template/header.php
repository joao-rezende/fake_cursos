...
<html lang="en">
    <head>
        ...
        <title>Fake Cursos <?php echo isset($title) ? (" - " . $title) : ""; ?></title>
        <!-- Bootstrap core CSS -->
        ...
        <nav class="navbar navbar-default navbar-shrink navbar-fixed-top">
            <div class="container">
                ...
                <div class="navbar-header page-scroll">
                    ...
                    <a class="navbar-brand page-scroll" href="#page-top"><img src="<?php echo base_url(); ?>public/images/logo_1.png" height="50" alt="Lattes theme logo"></a>
                </div>
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li>
                            <a class="page-scroll" href="<?php echo site_url(); ?>#portfolio">Cursos</a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a class="page-scroll" href="<?php echo site_url("restrict"); ?>">Login</a>
                        </li>
                    </ul>
                </div>
                <!-- /.navbar-collapse -->
